package com.example.android.moneymanager.data.Adapters;
...
public class AmountsCursorAdapter extends CursorAdapter {


    public AmountsCursorAdapter(Context context, Cursor c){
        super(context, c, 0);
    }
